...
def solve_gtsam_multi_demo(pcd_source,pcd_target,correspondence_max_clique_tuple_list,quadrics_info_source_stack,quadrics_info_target_stack,quadricsReg_config,T_gt=[]):
