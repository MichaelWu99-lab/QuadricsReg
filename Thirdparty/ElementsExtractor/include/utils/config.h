...
namespace g3reg {
    ...
    public:
        ...
        std::string dcvc_file, travel_file,dbscan_file, pcd_file, output_file;
        double z_up;
        ...
        int num_clusters, num_planes, num_lines;
        // GEM
        bool use_pseudo_cov, plane_aided, use_bbox_center, grad_pmc;
        bool save_ground, save_plane, save_line, save_cluster, remove_ground;
        // Back End
        // PAGOR
        int num_graphs = 0;
        ...
        double plane_resolution, plane_distance_thresh, plane_normal_thresh, eigenvalue_thresh, eigenvalue_thresh_line;

        bool keep_horizontal_plane, keep_horizontal_line;
